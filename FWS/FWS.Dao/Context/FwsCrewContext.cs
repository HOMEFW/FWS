...
using FWS.Dao.Migrations.Migrations_FwsCrew;
using FWS.Ent.Crew;
...
{
    public class FwsCrewInitialize : InitializetDataBase<FwsCrewContext, ConfigurationFwsCrew>
    {
    ...
    {
        public FwsCrewContext() : base("FWSCrew")
        {
        ...
        public static FwsCrewContext Create()
        {
            ...
            context.UserInfo.AddOrUpdate(p => p.nome, new eUserInfo() {memberId = user.Id, nome = name});
            context.SaveChanges();
